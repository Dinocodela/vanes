                      ...
                      <div class="row mx-0">
                        ...
                        <div class="col-lg-8 col-12 p-2 p-lg-8 p-xl-4 d-flex flex-column align-items-center">
                          <div class="contact_message">
                            Report any Issues with the application or contact us directly at  <a href="mailto:myresumedash@gmail.com">admin@vanessarezende.com</a>
        ...
        <footer class="footer d-none d-sm-block">
            <div class="footer-inner bgc-white-tp1">              
              ...
              <div class="pt-3 border-none border-t-3 brc-grey-l2 border-double">              
                ...
                <span class="text-primary-m1 font-bolder text-120">Vanessarezende</span>
                <span class="text-grey"> &copy; 2021</span>
