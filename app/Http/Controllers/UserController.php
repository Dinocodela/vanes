...
class UserController extends Controller
{
    ...
    public function contactForm(Request $request)
    {
        ...
        MailController::contactEmail($name, $email, $message);
        //show message
        return redirect()->back()->with(session()->flash('alert-success', 'Your contact form has been sent. We will be in touch with you soon.'));
